defmodule Iris.ChannelTest do
  ...
  test "create channel aggregate" do
    cmd = CreateChannel.new("name #1", "u1", ["u2"], "Hey!")
  ...
  test "create channel" do
    cmd = Iris.Command.CreateChannel.new("new channel", "user_1", [], "Zero")
  ...
  test "channel with 3 members get messages" do
    create_channel = Iris.Command.CreateChannel.new("Three amigos", "u1", ["u2", "u3"], "Hey guys")
